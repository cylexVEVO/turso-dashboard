    ...
    return (
        <>
            ...
            <div className={"mb-2 flex items-center"}>
                <select
                    className={"rounded-l-lg bg-transparent border border-neutral-300 p-2 h-[42px] font-mono"}
                    value={protocol}
                ...
                <div className={"border-y border-neutral-300 grow py-2 px-3 font-mono"}>
                    {props.hostname}
                </div>
                <button
